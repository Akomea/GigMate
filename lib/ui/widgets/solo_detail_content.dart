...
class SoloDetailContent extends StatefulWidget {
  @override
  _SoloDetailContentState createState() => _SoloDetailContentState();
}

class _SoloDetailContentState extends State<SoloDetailContent> {
