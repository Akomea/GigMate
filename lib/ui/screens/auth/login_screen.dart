...
import 'package:gigmate/ui/widgets/bottom_error_message.dart';
import 'package:gigmate/ui/widgets/error_message.dart';
...
//   }
  ...
  void initState() {
    ...
    if (user != null) {
      Navigator.popAndPushNamed(context, AppNavScreen.screenId);
    } else {
